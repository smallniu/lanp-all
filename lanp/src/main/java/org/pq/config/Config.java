...
import org.pq.config.impl.ConfigBuilder;
import org.pq.config.impl.IniConfigable;
import org.pq.config.impl.PropertiesConfigable;
import org.pq.config.impl.PropsConfigable;
import org.pq.config.impl.TableConfigable;
...
public class Config {
    ...
    private static void loadConfigImplementation() {
         ...
         *  例如：
         *  config.implementation=org.n3r.config.impl.RedisConfigable(127.0.0.1,11211)
        **/
    ...
    private static Configable createConfigable(String bizConfigDir, String defConfigDir, Configable defConfig) {
        ...
        Resource[] propertiesRes = RClassPath.getResources(basePackage, "**/*.properties");
        ...
        Resource[] tablesRes = RClassPath.getResources(basePackage, "**/*.table");
    ...
    private static Configable loadImpl(String configImplementation, Configable defConfig) {
        Configable config = ParamsApplyUtils.createObject(configImplementation, Configable.class);
